...
> **Статус:** рабочий прототип (MVP). Интеграция с AdTarget по умолчанию работает в mock-режиме.
...
> **`backend/chroma_db/` не версионируется** — индекс RAG пересобирается командой `python -m rag.indexer`.
